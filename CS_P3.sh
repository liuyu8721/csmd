...
seqtk seq -A ${CS_P3_INPUT} > ${CS_P3_RUNNING}/${CS_P3_SAMPLE}.hg19Removal.AHGRemoval.fasta
...
${CS_P3_RUNNING}/${CS_P3_SAMPLE}.hg19Removal.AHGRemoval.fasta -dir ${CS_P3_RUNNING}

### Extract the result file after LCR identification
java -jar ${CSMD_HOME}/WGSparser.jar parseRM \
${CS_P3_RUNNING}/${CS_P3_SAMPLE}.hg19Removal.AHGRemoval.fasta \
${CS_P3_OUTPUT}
